...
function payout() {
    ...
    var cancelBaseURL = '/v1/payments/payouts-item/'
    var operations = ['get'];

    var ret = {
        baseURL: baseURL,
        cancelBaseURL: cancelBaseURL,
        /**
        ...
        cancel: function cancel(payout_item_id, config, cb){
            // cb = (typeof config === 'function') ? config : cb;
            api.executeHttp('POST', this.cancelBaseURL + payout_item_id + "/cancel", {}, config, cb);
        }
    };
